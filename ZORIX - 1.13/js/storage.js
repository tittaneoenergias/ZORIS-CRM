...
class LocalStorage {
    ...
    initializeData() {
        ...
        // Sistema mantido como está - não limpar mais
    ...
    setupDefaultData() {
        // Default users with correct hashes
        const defaultUsers = [
            {
                id: "user_admin_001",
            ...
            },
            {
                ...
                email: "carlos@solarcrm.com", 
                senha: "1551618415", // demo123
                tipo: "engenheiro",
                ativo: true,
                ultimo_login: null,
                created_at: new Date().toISOString(),
